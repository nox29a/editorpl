...
const Header = () => {
  return (
    <header className=' bg-black backdrop-blur-sm py-6 w-full z-10 border-b-4 border-purple-800'>
      <div className='container mx-0 flex items-center justify-between h-full  '>
        ...
        <div className='grid grid-cols-2 text-base text-center sm:flex sm:flex-row sm:text-2xl sm:justify-end'>
