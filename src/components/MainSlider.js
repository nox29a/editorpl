    ...
    <>
      ...
      return <SwiperSlide key={index}>
          ...
          <div className='h-[400px] w-[400px]'>
            <div className='absolute font-semibold flex text-[35px] text-center uppercase z-20 text-primary border-2 rounded-full bg-black border-purple-800 w-[220px]  top-[190px] lg:left-44 lg:top-80 p-2'>{slide.title}</div>
