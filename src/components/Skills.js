...
const Skills = () => {
  return (
<div id='Videos' className='grid place-items-center pt-32 bg-black'>
  <div className='container mx-auto md:mx-0'>
    ...
    <div className='text-lg grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-8 gap-20'>
    {/* FIRST CARD */}
      <div  data-aos="flip-right" className='group w-72 sm:w-96 h-[500px] [perspective:1000px]'>
          <div className='bg-hero h-full border-2 border-purple-700 rounded-lg p-8 flex flex-col items-center transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]'>
            <div className='inset-0'>
              ...
              <div className='absolute inset-0 h-full-w-full rounded-xl bg-black/90 px-12 text-center text-white [transform:rotateY(180deg)] [backface-visibility:hidden]'> 
