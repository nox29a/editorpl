        ...
        <div class="invisible absolute inset-0 bg-gradient-to-b from-purple-500/20 to-black group-hover:visible">
          <div class="absolute inset-x-5 bottom-6">
            <div class="flex gap-3 text-white">
              ...
              <div>
                <p class="font-sembold text-xl text-gray-100">Tik Tok/Instagram/Youtube</p>
                <p class="text-gray-300">Cuts/Subtitles</p>
              </div>
            </div>
        ...
        <div class="invisible absolute inset-0 bg-gradient-to-b from-green-500/20 to-black group-hover:visible">
          <div class="absolute inset-x-5 bottom-6">
            <div class="flex gap-3 text-white">
              ...
              <div>
                <p class="font-sembold text-xl text-gray-100">Personal Videos</p>
                <p class="text-gray-300">Best memories for your family</p>
              </div>
            </div>
            <div class="flex justify-end gap-3 text-gray-200">
              <svg width="22" height="22" viewBox="0 0 512 512">
        ...
        <div class="invisible absolute inset-0 bg-gradient-to-b from-green-500/20 to-black group-hover:visible">
          <div class="absolute inset-x-5 bottom-6">
            <div class="flex gap-3 text-white">
              ...
              <div>
                <p class="font-sembold text-xl text-gray-100">Your trip summary</p>
